...
void RegisterScriptFunctions(){
	...
	ScriptEngine->RegisterObjectProperty("Info","const bool holding_left",asOFFSET(Info,holding_left));
	ScriptEngine->RegisterObjectProperty("Info","const bool holding_right",asOFFSET(Info,holding_right));
	ScriptEngine->RegisterObjectProperty("Info","const bool holding_a",asOFFSET(Info,holding_a));
	ScriptEngine->RegisterObjectProperty("Info","const bool holding_j",asOFFSET(Info,holding_j));
	ScriptEngine->RegisterObjectProperty("Info","const bool holding_d",asOFFSET(Info,holding_d));
	ScriptEngine->RegisterObjectProperty("Info","const bool up",asOFFSET(Info,up));
	ScriptEngine->RegisterObjectProperty("Info","const bool down",asOFFSET(Info,down));
	ScriptEngine->RegisterObjectProperty("Info","const bool left",asOFFSET(Info,left));
	ScriptEngine->RegisterObjectProperty("Info","const bool right",asOFFSET(Info,right));
	ScriptEngine->RegisterObjectProperty("Info","const bool A",asOFFSET(Info,A));
	ScriptEngine->RegisterObjectProperty("Info","const bool J",asOFFSET(Info,J));
	ScriptEngine->RegisterObjectProperty("Info","const bool D",asOFFSET(Info,D));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DrA",asOFFSET(Info,DrA));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DlA",asOFFSET(Info,DlA));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DuA",asOFFSET(Info,DuA));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DdA",asOFFSET(Info,DdA));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DrJ",asOFFSET(Info,DrJ));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DlJ",asOFFSET(Info,DlJ));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DuJ",asOFFSET(Info,DuJ));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DdJ",asOFFSET(Info,DdJ));
	ScriptEngine->RegisterObjectProperty("Info","const int8 DJA",asOFFSET(Info,DJA));
	ScriptEngine->RegisterObjectProperty("Info","const int hp",asOFFSET(Info,hp));
	ScriptEngine->RegisterObjectProperty("Info","const int dark_hp",asOFFSET(Info,dark_hp));
	ScriptEngine->RegisterObjectProperty("Info","const int max_hp",asOFFSET(Info,max_hp));
	ScriptEngine->RegisterObjectProperty("Info","const int mp",asOFFSET(Info,mp));
	ScriptEngine->RegisterObjectProperty("Info","const int frame",asOFFSET(Info,frame));
	ScriptEngine->RegisterObjectProperty("Info","const int bdefend",asOFFSET(Info,bdefend));
	ScriptEngine->RegisterObjectProperty("Info","const int fall",asOFFSET(Info,fall));
	ScriptEngine->RegisterObjectProperty("Info","const int team",asOFFSET(Info,team));
	ScriptEngine->RegisterObjectProperty("Info","const int id",asOFFSET(Info,id));
	ScriptEngine->RegisterObjectProperty("Info","const int blink",asOFFSET(Info,blink));
	ScriptEngine->RegisterObjectProperty("Info","const int state",asOFFSET(Info,state));
	...
	ScriptEngine->RegisterObjectProperty("Info","const int vrest",asOFFSET(Info,vrest));
	ScriptEngine->RegisterObjectProperty("Info","const double x_velocity",asOFFSET(Info,x_velocity));
	ScriptEngine->RegisterObjectProperty("Info","const double y_velocity",asOFFSET(Info,y_velocity));
	ScriptEngine->RegisterObjectProperty("Info","const double z_velocity",asOFFSET(Info,z_velocity));
	ScriptEngine->RegisterObjectProperty("Info","const int clone",asOFFSET(Info,clone));
	ScriptEngine->RegisterObjectProperty("Info","const int type",asOFFSET(Info,type));
	ScriptEngine->RegisterObjectProperty("Info","const int reserve",asOFFSET(Info,reserve));
	ScriptEngine->RegisterObjectProperty("Info","const DataFile @data",asOFFSET(Info,data));
